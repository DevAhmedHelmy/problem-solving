...
<pre style="position: relative;"><strong>Input:</strong> arr = [1,2,3,4,5], size = 1
...
<pre style="position: relative;"><strong>Input:</strong> arr = [1,9,6,3,2], size = 3
...
<pre style="position: relative;"><strong>Input:</strong> arr = [8,5,3,2,6], size = 6
...
<pre style="position: relative;"><strong>Input:</strong> arr = [], size = 1
<strong>Output:</strong> []
<strong>Explanation:</strong> There are no elements to be chunked so an empty array is returned.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
